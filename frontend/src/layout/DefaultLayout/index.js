        ...
        <div className="bg-[#fff] dark:bg-[#282828] min-h-[100vh]">
            ...
            {isShowButtonScroll &&
                <button
                    ...
                    onClick={scrollToTop} 
                    className='w-[40px] flex items-center justify-center h-[40px] rounded-[8px] bg-[#e4d71c] fixed lg:bottom-[32px] lg:left-[32px] mobile:bottom-[16px] mobile:left-[16px] text-[#fff] animate-fade-in cursor-pointer hover:scale-[1.05] duration-300'>
