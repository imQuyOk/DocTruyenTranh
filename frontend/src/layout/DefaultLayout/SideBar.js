                ...
                <li className="relative">
                    ...
                    {quantityComicArchive > 0 &&
                        <div className="absolute right-[-4px] top-[-4px] flex items-center justify-center">
                            <span className="w-[20px] h-[20px] bg-[#e4d71c7a] rounded-full animate-ping"></span>
                            <span className="absolute rounded-full w-[20px] h-[20px] flex items-center shadow-sm justify-center bg-[#e4d71c] text-[#fff] text-xs">{quantityComicArchive}</span>
                        </div>}
                </li>
                <li className="relative">
                    <NavLink
                    ...
                    {quantityComicHistory > 0 &&
                        <div className="absolute right-[-4px] top-[-4px] flex items-center justify-center">
                            <span className="w-[20px] h-[20px] bg-[#e4d71c7a] rounded-full animate-ping"></span>
                            <span className="absolute rounded-full w-[20px] h-[20px] flex items-center shadow-sm justify-center bg-[#e4d71c] text-[#fff] text-xs">{quantityComicHistory}</span>
                        </div>}
                </li>
