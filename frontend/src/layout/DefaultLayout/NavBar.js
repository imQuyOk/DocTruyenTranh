    ...
    return (
        <div className="flex items-center justify-between sticky top-0 left-0 right-0 h-[60px] bg-[#fff] text-[#000] z-[999] lg:px-[32px] md:px-[23px] px-[16px] border-b border-slate-900/10 dark:bg-[#282828] dark:border-[#cccccc5b]">
            ...
            <div className="flex gap-[12px] items-center">
                ...
                <NavLink to='/' className="lg:text-2xl mobile:text-xl text-[#e4d71c] font-[900]">
                    DOCTRUYEN
                </NavLink>
            </div>
            {width > 1024 &&
                <div className="h-[40px] flex items-center p-[4px] border-2 border-solid border-[#ccc] dark:border-[#636363] rounded-[8px] ml-[12px] w-[420px] focus-within:border-[#e4d71c] shadow-sm hover:border-[rgb(16,185,129)] dark:hover:border-[#808080] dark:focus-within:border-[#808080]">
                    <input
                        value={valueSearch}
                    ...
                    {valueSearch.length > 0 &&
                        <button
                            title="Xoá nội dung"
                            className="dark:text-[#fff] duration-300 hover:text-[#e4d71c]" onClick={() => setValueSearch("")}>
            ...
            <div className="flex gap-[12px] items-center">
                ...
                {isLogin ? (
                    ...
                    <div className="flex gap-2">
                        <Login />
                        <NavLink to="/login" className="bg-green-500 text-white px-4 py-2 rounded">
                             Đăng Nhập
                        </NavLink>
                         <NavLink to="/register" className="bg-blue-500 text-white px-4 py-2 rounded">
                             Đăng Ký
                         </NavLink>
                     </div>
