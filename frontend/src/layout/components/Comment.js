                ...
                <div ref={modalRef} className='lg:w-[50%] mobile:w-full bg-[#fff] dark:bg-[#282828] dark:text-[#fff] lg:pl-[32px] lg:pr-[32px] lg:pt-0 lg:pb-[32px] mobile:p-[16px] relative max-h-[100vh] overflow-y-auto overscroll-y-none animate-from-rigth-in'>
                    ...
                    <div className='mt-[64px]'>
                        ...
                        <div className='mt-[32px] mb-[64px]'>
                            <textarea
                                className='p-[16px] min-h-[160px] w-full mb-[12px] border-2 border-solid border-[#ccc] duration-300 bg-transparent text-base focus:border-[#e4d71c] outline-none rounded-[8px]'
                                value={valueComment}
                                onChange={e => setValueComment(e.target.value)}
                                placeholder='Nhập nội dung bình luận...'>
                            </textarea>
                            <button
                                className={`flex ml-auto py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] text-lg transition-all hover:scale-[1.05] text-[#fff] select-none ${valueComment !== '' ? 'bg-[#e4d71c] pointer-events-auto' : 'bg-[rgba(16,185,129,0.45)] pointer-events-none'}`}
                                ...
                                <li className='flex gap-[16px]' key={index}>
                                    ...
                                    <div className='w-full h-full p-[12px] rounded-[8px] bg-[#f2f3f5] dark:bg-[rgba(204,204,204,0.2)]'>
                                        <div className=''>
                                                        ...
                                                        {comment?.value.split(' ').map((cmt, index) => (
                                                            <Fragment key={index}>{
                                                                !isUrlWithValidDomainSuffix(cmt) ? ` ${cmt} ` : (
                                                                    <a
                                                                        className='font-[600] text-[#e4d71c] hover:underline'
                                                                        href={cmt}
                                                                        target="_blank"
                                            ...
                                            {index === indexEdit &&
                                                <textarea
                                                    className='lg:p-[16px] mobile:p-[8px] min-h-[160px] w-full mb-[12px] border-2 border-solid border-[#ccc] duration-300 text-base focus:border-[#e4d71c] outline-none rounded-[8px]  dark:bg-transparent dark:text-[#fff]'
                                                    ref={commentEditRef}
                                            ...
                                            {index !== indexEdit &&
                                                <Fragment>
                                                    <span
                                                        ...
                                                        className='text-[#e4d71c] font-[600] cursor-pointer select-none text-base duration-300 hover:underline'>Xoá</span>
                                                    <span className=''> · </span>
                                                    <span
                                                        onClick={() => handleEditComment(index)}
                                                        className='text-[#e4d71c] font-[600] cursor-pointer select-none text-base duration-300 hover:underline'>Chỉnh sửa</span>
                                                    <span className=''> · </span>
                                                </Fragment>
                                            }
                                            {index === indexEdit &&
                                                <Fragment>
                                                    <span
                                                        ...
                                                        className='text-[#e4d71c] font-[600] cursor-pointer select-none text-base duration-300 hover:underline'>Huỷ</span>
                                                    <span className=''> · </span>
                                                    <span
                                                        onClick={handleSaveEditComment}
                                                        className='text-[#e4d71c] font-[600] cursor-pointer select-none text-base duration-300 hover:underline'>Lưu</span>
                                                    <span className=''> · </span>
                                                </Fragment>
                                            }
