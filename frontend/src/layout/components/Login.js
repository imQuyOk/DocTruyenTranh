...
function Login() {
    ...
    return (
        <button onClick={handleLogin} className="bg-[#e4d71c] text-sm px-[16px] py-[8px] rounded-[8px] text-[#fff] font-[600] transition-all hover:opacity-[.8]">Đăng nhập Google</button>
    );
}
