                ...
                <div
                    ...
                    <div className="w-full flex gap-[32px] absolute z-[2] lg:left-[64px] left-[16px]">
                        ...
                        <div className="lg:w-desktop w-mobile mobile:mt-[16px]">
                            ...
                            <h2 className="text-shadow lg:text-4xl mobile:text-xl font-[600] truncate text-[#e4d71c] my-[12px]">{data?.name}</h2>
                            <ul className='flex flex-wrap gap-[12px] mt-[16px]'>
                                {data?.category.map((category, index) => (
                                    <li className="" key={index}>
                                        <Link className="block text-base font-[600] px-[8px] py-[2px] rounded-[8px] border-2 border-solid border-[#fff] bg-transparent transition-all select-none hover:text-[#e4d71c] hover:border-[#e4d71c]" to={`/detail/the-loai/${category?.slug}`}>{category?.name}</Link>
                                    </li>
                                ))}
                            </ul>
                            {data?.chaptersLatest &&
                                <div className="flex gap-[12px] mt-[16px] select-none">
                                    <Link
                                        className="py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-lg transition-all hover:scale-[1.05] bg-[#e4d71c]"
