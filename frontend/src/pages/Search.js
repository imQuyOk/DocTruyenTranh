...
function Search() {
    ...
    return (
        <div className=''>
            ...
            {data &&
                <Fragment>
                    <h4 className="mb-[32px] lg:text-2xl mobile:text-xl font-[600] text-[#e4d71c] dark:text-[#fff] p-[8px] rounded-[8px] border-2 border-solid border-[#e4d71c] dark:border-[#636363] bg-[rgba(16,185,129,0.15)] dark:bg-[rgba(204,204,204,0.2)]">
                        {result.length > 0 ?
                            `Tìm kiếm được 
                                ${data?.data?.params?.pagination?.totalItems} 
