            ...
            {data &&
                <Fragment>
                    <div className='lg:flex lg:flex-row mobile:flex-col mobile:gap-[12px] p-[16px] bg-[rgba(16,185,129,0.15)] rounded-[8px] dark:bg-[rgba(204,204,204,0.2)]'>
                        ...
                        <div className='overflow-hidden flex flex-col gap-[4px] flex-1 lg:pl-[32px]'>
                            ...
                            <div className='flex gap-[12px] my-[12px] select-none'>
                                {!isSave ? (
                                    <button
                                        ...
                                        className='py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-lg duration-300 font-[600] hover:scale-[1.05] bg-[#e4d71c] text-[#fff]'>
                            ...
                            <ul className='flex gap-[12px] text-lg flex-wrap'>
                                <b className="text-[#e4d71c]">Tác giả: </b>
                            ...
                            <div className='flex gap-[12px] text-lg'>
                                <b className="text-[#e4d71c]">Ngày cập nhật:</b>
                                <span className='dark:text-[#fff]'>{formatDate(infoComic?.updatedAt)}</span>
                            </div>
                            <ul className='flex gap-[12px] text-lg flex-wrap'>
                                <b className="text-[#e4d71c]">Thể loại: </b>
                                {category.map((category, index) => (
                                    <li key={index} className='transition-all hover:scale-[1.05]'>
                                        <Link className="px-[6px] py-[4px] bg-[#e4d71c] rounded-[8px] text-sm text-[#fff]" to={`/detail/the-loai/${category?.slug}`}>
                                            {category?.name}
                                        </Link>
                                    </li>
                                ))}
                            ...
                            <div>
                                <b className="text-[#e4d71c] text-lg">Nội dung: </b>
                                <p
                    ...
                    <div className='mt-[32px]'>
                        <div className='flex items-center justify-between'>
                            ...
                            {chapters.length > 0 &&
                                <button
                                    ...
                                    className='text-lg py-[6px] px-[12px] rounded-[8px] bg-[#e4d71c] text-[#fff] transition-all hover:scale-[1.05]'
                                >
                                    {isSort ? (
                        ...
                        {width > 1024 &&
                            <p className="my-[16px] font-[600] text-[#e4d71c]">
                                Gợi ý: Bạn có thể cuộn con lăn chuột để chọn chương
                            </p>}
                        <div className='flex items-center w-full px-[12px] rounded-[8px] border-2 border-solid border-[#ccc] focus-within:border-[#e4d71c] my-[12px] dark:text-[#fff]'>
                        ...
                        <div className="mb-[24px] flex gap-[16px] dark:text-[#fff]">
                            ...
                            <div className="flex gap-[12px] items-center">
                                <div className="w-[40px] h-[20px] rounded-[6px] bg-[#e4d71c]"></div>
                                <span>Chưa đọc</span>
                            </div>
                            <div className="flex gap-[12px] items-center">
                                <div className="w-[40px] h-[20px] rounded-[6px] bg-[#e4d71cb3]"></div>
                                <span>Đã đọc</span>
                            </div>
                        </div>
                                ...
                                <Fragment>
                                    {isSort ? (
                                        <li className="xl:w-chapter-desktop lg:w-chapter-table mobile:w-chapter-mobile">
                                            <Link
                                                className="py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-sm transition-all hover:scale-[1.05] bg-[#e4d71c] text-[#fff] text-center"
                                    ...
                                    {chapters.map((chapter, index) => (
                                        <li
                                            className={` transition-all hover:scale-[1.05] rounded-[8px] xl:w-chapter-desktop   lg:w-chapter-table mobile:w-chapter-mobile relative ${idStorage.includes(chapter?.chapter_api_data.split('/').pop()) ? "bg-[#e4d71cb3]" : 'bg-[#e4d71c]'}`}
                                            key={index}>
                                            <Link
                        ...
                        {(width > 1024 ?
                            ...
                            <div className="flex justify-center mt-[16px]">
                                <span
                                    className="text-[#e4d71c] font-[900] cursor-pointer text-lg select-none"
