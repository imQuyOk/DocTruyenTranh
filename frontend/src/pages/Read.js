                ...
                {data && dataChapter &&
                    <div className='bg-[rgba(16,185,129,0.15)] dark:bg-[rgba(204,204,204,0.2)] w-full p-[16px] rounded-[8px]'>
                        <div className='flex justify-center items-center flex-col gap-[16px] dark:text-[#fff]'>
                            ...
                            <span className='text-lg font-[600] text-center text-[#d90429] dark:text-[#fff]'>Nếu truyện bị lỗi vui lòng liên hệ  
                                <a href="#" target="_blank" rel="noopener" className='ml-[12px] underline'>Nhóm 17</a>
                            </span>
                        </div>
                        <div className='flex gap-[8px] justify-center mt-[24px]'>
                            <button
                                onClick={handlePrevChapter}
                                className={`select-none py-[4px] px-[12px] mobile:px-[8px] rounded-l-[8px] block text-lg transition-all hover:scale-[1.05] text-[#fff] ${currentIndex === 0 ? 'pointer-events-none bg-[rgba(16,185,129,0.48)]' : 'pointer-events-auto bg-[#e4d71c]'}`}
                            >
                            ...
                            <button
                                ...
                                className={`select-none py-[4px] px-[12px] mobile:px-[8px] rounded-r-[8px] block text-lg transition-all hover:scale-[1.05] text-[#fff] ${currentIndex === chapter.length - 1 ? 'pointer-events-none bg-[rgba(16,185,129,0.48)]' : 'pointer-events-auto bg-[#e4d71c]'}`}
                            >
                                Chương sau
                    ...
                    <Fragment>
                        {!isShowTools ? (
                            <button
                                ...
                                className='select-none py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-lg transition-all hover:scale-[1.05] bg-[#e4d71c] text-[#fff] fixed lg:bottom-[32px] lg:right-[32px] mobile:right-[16px] mobile:bottom-[16px]'>
                            ...
                            <Fragment>
                                ...
                                <div className='fixed z-[9999] max-w-[300px] min-w-[50px] lg:right-[32px] lg:bottom-[32px] mobile:right-[16px] mobile:bottom-[16px] flex flex-col gap-[12px] lg:p-[16px] mobile:p-[8px] rounded-[16px] shadow-sm bg-[rgba(16,185,129,0.15)] dark:bg-[rgba(204,204,204,.2)]'>
                                    <select
                                        ...
                                        className='min-h-[36px] select-none py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-lg bg-[#e4d71c] text-[#fff] outline-none cursor-pointer'>
                                    ...
                                    <button
                                        onClick={handlePrevChapter}
                                        className={`select-none py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-lg transition-all hover:scale-[1.05] text-[#fff] ${currentIndex === 0 ? 'pointer-events-none bg-[rgba(16,185,129,0.48)]' : 'pointer-events-auto bg-[#e4d71c]'}`}
                                    >
                                        <i className="mr-[8px] fa-solid fa-angle-left"></i>
                                        Chương trước
                                    </button>
                                    <button
                                        onClick={handleNextChapter}
                                        className={`select-none py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-lg transition-all hover:scale-[1.05] text-[#fff] ${currentIndex === chapter.length - 1 ? 'pointer-events-none bg-[rgba(16,185,129,0.48)]' : 'pointer-events-auto bg-[#e4d71c]'}`}
                                    >
                                        Chương sau
                                        <i className="ml-[8px] fa-solid fa-angle-right"></i>
                                    </button>
                                    <button
                                        className='select-none py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-lg transition-all hover:scale-[1.05] bg-[#e4d71c] text-[#fff]'
                                        onClick={handleOpenModal}>
                                        <i className="mr-[8px] fa-regular fa-comment-dots"></i>
                                        <span>Bình luận</span>
                                    </button>
                                    <button
                                        className={`select-none py-[4px] px-[12px] mobile:px-[8px] rounded-[8px] block text-lg transition-all hover:scale-[1.05] bg-[#e4d71c] text-[#fff] ${isScroll && 'animate-pulse'}`}
